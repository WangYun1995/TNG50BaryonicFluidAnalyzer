...
# Choose gas cells
temp_mask       = temperature > 1.e7
mass_hot        = mass_gas[temp_mask]
coord_hot       = coord_gas[temp_mask,:] 
total_mass_rank = np.sum(mass_hot)
...
# Construct Catalog
catalog_dict = {'Coordinates':coord_hot,'Masses':mass_hot}
hot_cat      = ArrayCatalog(catalog_dict, comm=comm)
# Create mesh 
mesh         = hot_cat.to_mesh(Nmesh=nmesh,BoxSize=boxsize,dtype='f4',compensated=False, 
