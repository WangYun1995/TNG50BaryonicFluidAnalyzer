...
# Choose gas cells
temp_mask       = temperature < 1.e5
mass_warm       = mass_gas[temp_mask]
coord_warm      = coord_gas[temp_mask,:] 
total_mass_rank = np.sum(mass_warm)
...
# Construct Catalog
catalog_dict = {'Coordinates':coord_warm,'Masses':mass_warm}
warm_cat     = ArrayCatalog(catalog_dict, comm=comm)
# Create mesh 
mesh         = warm_cat.to_mesh(Nmesh=nmesh,BoxSize=boxsize,dtype='f4',compensated=False, 
